...
This project implements a custom shell program that can execute commands, manage aliases, and run script files. The shell supports various features such as command execution, alias management, script execution, and tracking of command statistics.
...
When exiting the shell, it prints the total number of apostrophes (single quotes) encountered during execution.
